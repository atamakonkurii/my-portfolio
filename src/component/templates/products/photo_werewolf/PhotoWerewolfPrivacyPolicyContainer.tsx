export const PhotoWerewolfPrivacyPolicyContainer = () => {
  return (
    <div className="container mx-auto w-11/12 max-w-5xl">
      ...
      <ul className="ml-8 list-disc">
        <li>本サービスの滞在時間、入力履歴等のお客様の行動履歴</li>
      </ul>
      <h2 className="mt-16 mb-2 text-xl font-semibold">
        お客様の情報を利用する目的
      </h2>
      ...
      <p>
        当方は、お客様のアクセス解析のために、「Googleアナリティクス」を利用しています。トラフィックデータは匿名で収集されており、個人を特定する者ではありません。Googleアナリティクスについて、詳しくは以下からご確認ください。
      </p>
      <a
      ...
      <h2 className="mt-16 mb-2 text-xl font-semibold">連絡先</h2>
      <a
        href="https://forms.gle/obHiSBQkNNaB6CPS8"
        className="pt-4 text-blue-500"
      >
        お問い合わせ
      </a>
